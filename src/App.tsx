        ...
        <div className="container">
          <div className="update-box">
            <div className="update-left">
              <h3>Tải bản cập nhật mới</h3>
              <p>Mỗi phiên bản mới đều mang lại các nâng cấp về hiệu năng và bổ sung các tính năng hữu ích để hỗ trợ tối đa việc luyện thi.</p>
              <a href={versionInfo.download_url} target="_blank" rel="noopener noreferrer" className="btn-primary">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                  <polyline points="7 10 12 15 17 10" />
